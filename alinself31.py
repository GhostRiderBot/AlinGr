...
gr2 = LINETCR.LINE() 
gr2.login(token="EqieaStSBkqTllHbeDQb.FCvRR/tACAdmpj9ZglA/EW.HrZbrxPVt6qXMv+DAPL4tUndfi3bP2kics5ga1xiIBY=")
gr2.loginResult()

gr3 = LINETCR.LINE() 
gr3.login(token="EruadOsOZP7DU3MD0p37.AuhqRDQcBXMRmcCL9U0ifW.D00QUK8ptwR1u//1GsjyFkD9LjrO2lS2M6cc8WyOMxI=")
gr3.loginResult()
...
KAC=[alin,gr1,gr2,gr3]
mid = alin.getProfile().mid
gr1mid = gr1.getProfile().mid
gr2mid = gr2.getProfile().mid
gr3mid = gr3.getProfile().mid
Bots=[mid,gr1mid,gr2mid,gr3mid]
    ...
    try:
        ...
        if op.type == 26:
            ...
            if msg.contentType == 16:
                ...
                gr2.like(url[25:58], url[66:], likeType=1001)
                gr3.like(url[25:58], url[66:], likeType=1001)
                alin.comment(url[25:58], url[66:], wait["comment1"])
                gr1.comment(url[25:58], url[66:], wait["comment1"])
                gr2.comment(url[25:58], url[66:], wait["comment1"])
                gr3.comment(url[25:58], url[66:], wait["comment1"])
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': gr3mid}
                gr3.sendMessage(msg)
...
#                else:
                ...
                if len(string.decode('utf-8')) <= 20:
                    profile = gr3.getProfile()
                    profile.displayName = string
                    gr3.updateProfile(profile)
...
#--------------------------------------------------------
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    profile.displayName = string
                    gr3.updateProfile(profile)
                    gr3.sendText(msg.to,"􀜁􀇔􏿿Update Names👉" + string + "â‡‡â‡‡👈")
#--------------------------------------------------------
...
#	      if msg.from_ in admin:
		       ...
		       alin.sendText(msg.to,"Ghost Rider Squad")
                       ...
                       gr3.sendText(g.mid,"Ghost Rider Squad")
                       alin.sendText(g.mid,"Ghost Rider Squad")
                       gr1.sendText(g.mid,"Ghost Rider Squad")
                       gr2.sendText(g.mid,"Ghost Rider Squad")
                       gr3.sendText(g.mid,"Ghost Rider Squad")
                ...
                if msg.toType == 2:
                    ...
                    for jj in matched_list:
                        try:
                            ...
                            gr3.kickoutFromGroup(msg.to,[jj])
                            print (msg.to,[jj])
                        except:
                            pass
                        ...
                        for target in targets:
                          if not target in Bots:
                            try:
                                ...
                                gr3.sendText(msg,to,"Nuke Succes Bos")
#-------------------- = NUKE FINISH = ----------------------------- 
...
#-----------------------------------------------
                ...
                gr3.sendText(msg.to, "%sseconds" % (elapsed_time))
#-----------------------------------------------
                        ...
                        time.sleep(0.01)
                        gr3.acceptGroupInvitationByTicket(msg.to,Ticket)
                        time.sleep(0.01)
                        G = alin.getGroup(msg.to)
                        ginfo = alin.getGroup(msg.to)
                        G.preventJoinByTicket = True
            ...
            try:
                if op.param3 in mid:
                    if op.param2 in gr1mid:
                        ...
                        gr3.acceptGroupInvitationByTicket(op.param1,Ticket)
                        G.preventJoinByTicket = True
                        alin.updateGroup(G)
                    else:
                        G = gr1.getGroup(op.param1)
                    ...
                    if op.param2 in gr3mid:
                        G = gr3.getGroup(op.param1)
                        G.preventJoinByTicket = False
                        gr3.updateGroup(G)
                        Ticket = gr3.reissueGroupTicket(op.param1)
                        alin.acceptGroupInvitationByTicket(op.param1,Ticket)
                        gr1.acceptGroupInvitationByTicket(op.param1,Ticket)
                        gr2.acceptGroupInvitationByTicket(op.param1,Ticket)
                        gr3.acceptGroupInvitationByTicket(op.param1,Ticket)
                        ...
                        gr3.kickoutFromGroup(op.param1,[op.param2])
